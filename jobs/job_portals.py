    ...
    def __init__(self):
        ...
        self.portals = [
            ...
            },
          {
            ...
            "color": "#003A9B",
            "url": "https://www.instahyre.com/search-jobs/?q={}&l={}",
            "experience_param": ""
            },
...
#The main function. user give it a job title, location, and experience level, and it:Creates a ready-to-use web link (URL) for each portal.Returns a list of links you can click to see job results.
